module.exports = function (a) {
	a.initConfig({
		...
		uglify : {
			compress : {
				...
				files : {
					"js/oldversion/main.min.js" : ["js/oldversion/main.js"]
				}
			},
			betigruntjs : {
				options : {
	...
	a.loadNpmTasks("grunt-contrib-connect"),
	a.loadNpmTasks("grunt-contrib-jshint"),
	a.loadNpmTasks('grunt-contrib-cssmin'),
	a.registerTask("betigruntjs", ["uglify:betigruntjs"]),
	//a.registerTask("betiself", [ "uglify:betiself" ]),
